...
<div class="container">
    <div class="row">
        <div class="offset-lg-3 offset-md-3 col-6">
            <h1>Reactivate Deleted Account</h1>
            <br>
            <form method="post" action="{{ URL::to('/') }}/Reactivate_account">
                @csrf
                <div class="row">
                    <div class="col">
                ...
                <div class="row" style="text-align:center;">
                    <div class="col">
                        <input type="submit" value="Reactivate" name="btn-login" class="btn btn-danger">
